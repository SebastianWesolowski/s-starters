    ...
    <Container>
      <div className='py-16'>
        ...
        <nav className='mt-10 text-sm' aria-label='quick links'>
          <ul className='-my-1 flex justify-center space-x-6'>
            <li>
              <Link
                href='Typescript-Tailwind-NextJS/src/components/molecules/Footer#features'
            ...
            <li>
              <Link
                href='Typescript-Tailwind-NextJS/src/components/molecules/Footer#testimonials'
                className='rounded-lg px-2 py-1 text-slate-700 hover:bg-slate-100 hover:text-slate-900'
              >
                Testimonials
              </Link>
            ...
            <li>
              <Link
                href='Typescript-Tailwind-NextJS/src/components/molecules/Footer#pricing'
                className='rounded-lg px-2 py-1 text-slate-700 hover:bg-slate-100 hover:text-slate-900'
              >
                Pricing
              </Link>
      ...
      <div className='flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between'>
        <div className='flex space-x-6'>
          <Link href='Typescript-Tailwind-NextJS/src/components/molecules/Footer#' className='group'>
